...
- [x] `AppHeader.vue` placeholder created (title + phase indicator + nested `RaceControls`). Dedicated test cycle pending — currently exercised indirectly via `App.test.ts` stubs.
